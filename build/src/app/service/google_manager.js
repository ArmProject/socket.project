  ...
  function ($q) {
    ...
    this.getUser = function () {
      ...
      service['oauth2'].userinfo.get().execute(function (data) {
        ...
        service['plus'].people.get({ 'userId': 'me' }).execute(function (data) {
    ...
    this.getFile = function (id) {
      var deferred = $q.defer();
      var request = service['drive'].files.get({ 'fileId': id });
      request.execute(function (resp) {
    ...
    this.listFile = function () {
      ...
      var retrievePageOfFiles = function (request, result) {
        request.execute(function (resp) {
          ...
          if (nextPageToken) {
            request = service['drive'].files.list({ 'pageToken': nextPageToken });
      ...
      var initialRequest = service['drive'].files.list({ 'q': 'mimeType=\'application/vnd.google-apps.presentation\'' });
